...
class Convergence:
    ...
    def plot_summary(self):
        ...
        if not os.path.exists(pic_path+self.sys_para.circuit_name):
	    os.makedirs(pic_path+self.sys_para.circuit_name)
	plt.savefig(pic_path+ self.sys_para.circuit_name+"convergence.png")
